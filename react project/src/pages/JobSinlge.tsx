...
import { useLoaderData, Link, useNavigate, LoaderFunction } from "react-router-dom";
import { Job } from "../interface/Jobs";
import { toast } from "react-toastify";


const JobSingle = ({ deleteJob }: { deleteJob: (id: string) => Promise<void> }) =>  {
    //const { id } = useParams();
    const navigate = useNavigate()
    const job = useLoaderData() as Job;

    const onDeleteJob = (id: string | undefined) => {
